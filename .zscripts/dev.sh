...
log_step_start "Starting PostgreSQL"
bash "$PROJECT_DIR/scripts/start-pg.sh" || { echo "ERROR: Failed to start PostgreSQL"; exit 1; }
log_step_end "Starting PostgreSQL"
...
DATABASE_URL="postgres://z@localhost:5432/myproject" bun run db:push
log_step_end "bun run db:push"

log_step_start "Starting Next.js dev server"
echo "[BUN] Starting development server..."
DATABASE_URL="postgres://z@localhost:5432/myproject" bun run dev &
DEV_PID=$!
